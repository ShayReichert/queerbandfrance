  ...
  <Layout>
    ...
    <div className="mentions-conditions">
      ...
      <section>
        ...
        <p>
          <strong>Propriétaires</strong> : Shay Reichert et{' '}
          <a
          ...
          <a href="https://queerbandfrance.com/">Shay Reichert</a>
          <br />
          <strong>Responsable publication</strong> : L'équipe This is a RIOT –
          thisisariot.asso@gmail.com
          <br />
        ...
        <p>
          ...
          est mis à jour régulièrement par This is a RIOT. De la même façon, les
        ...
        <p>
          ...
          a pour objet de fournir des informations sur des groupes de musiques.
        </p>
        <p>
          This is a RIOT s’efforce de fournir sur le site{' '}
          <a href="http://https://queerbandfrance.com/">
            https://queerbandfrance.com/
          </a>{' '}
        ...
        <p>
          Le créateur du site est propriétaire des droits de propriété
        ...
        <p>
          Le propriétaire du site ne pourra être tenue responsable des dommages
          directs et indirects causés au matériel de l’utilisateur, lors de
          l’accès au site https://queerbandfrance.com/, et résultant soit de
        ...
        <p>
          Le propriétaire du site ne pourra également être tenue responsable des
        ...
        <p>
          ...
          échéant, Le propriétaire du site se réserve également la possibilité
          de mettre en cause la responsabilité civile et/ou pénale de
          l’utilisateur, notamment en cas de message à caractère raciste,
          injurieux, diffamant, pornographique ou x-phobes, quel que soit le
        ...
        <p>
          ...
          mis en place avec l’autorisation du propriétaire du site. Cependant,
          le propriétaire du site n’a pas la possibilité de vérifier le contenu
